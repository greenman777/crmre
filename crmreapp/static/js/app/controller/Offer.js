Ext.define('CRMRE.controller.Offer', {
    ...
    sendObjects: function(button) {
        ...
        if (grid.getXType()=="appOfferBuyList"){
        	textMessage = 'Вы действительно хотите сохранить и отправить все найденные предложения по объектам клиенту?';
        }
        else {
			            ...
			            Ext.Ajax.request({
					        ...
					        success: function(response, opts) {
	                            ...
	                            if (failure_send_clients.length == 0) {
	                                ...
	                                Ext.Msg.alert('Извещение', 'Предложения отправлены!<br>'+'Клиенты: '+ 
